...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2021 at 07:20 AM
...
(3, 1, 'gohl50gvrnis1reqb3c33bubgd', NULL, NULL),
(8, 1, 'gohl50gvrnis1reqb3c33bubgd', NULL, NULL),
(1, 1, 'pjan7ctdrhalpbofr8nj7rtdqn', NULL, NULL),
(50, 1, 'm80v2lioce1k5jve94viug9eh5', NULL, NULL);
...
(46, 'American Lager Beer', 'This American classic is brewed with 1000% ice-cold Rocky Mountain water for pure lager refreshment. Light, crisp, refreshing, and oh so sexy. ABV 5.0%', '7.99', 'american-lager-beer', 'no', 'Sat', 'All', 'dr-2', 6),
(47, 'Tropical Margaritas', 'Tropical margaritas are like the best fruit smoothies with tequila added in and turned into margaritas. And there’s a tropical twist to them too.', '8.99', 'tropical-margaritas', 'yes', 'Sun', 'Lunch', 'dr-4', 6),
(48, 'Red wine cocktail', 'Red wine cocktail is essentially a wine punch, it\'s the perfect refreshing mixed drink, featuring wine-soaked fruit, brandy, and a hint of orange liqueur.', '7.99', 'red-wine-cocktail', 'yes', 'Fri', 'Dinner', 'dr-3', 6),
(49, 'Strawberry Smoothie', 'This strawberry smoothie is  is made with real strawberries, mixed with smooth, velvety noosa yoghurt. It is very healthy and refreshing way to start any day! ', '5.99', 'strawberry-smoothie', 'no', 'Thu', 'Breakfast', 'dr-15', 6),
(50, 'Orange Lemon Juice', 'Try our homemade, freshly squeezed orange and lemon juice that is a very popular beverage for kids and teens. Served with ice in a tall glass. ', '4.99', 'orange-lemon-juice', 'no', 'Tue', 'All', 'dr-20', 6),
(51, 'Hot Tea', 'Enjoy the very best whole-leaf hot teas and tea blend drinks from Sri Lanka, China, Thailand, Japan and India.', '1.99', 'hot-tea', 'no', 'Wed', 'All', 'dr-16', 6),
(52, 'Party Platter Subs', 'Choose your combination from Pepperoni, Turkey, Roast Beef, Ham, Ultimate, American, Italian, Deluxe, or Veggie. Serves up to 8.', '34.99', 'party-platter-subs', 'no', 'Fri', 'Lunch', 'par-3', 7),
(53, 'Party Platter Trio', 'Why choose one when you can choose three? Choose any three appetizers. Served with dipping sauces. Serves up to 8.', '39.99', 'party-platter-trio', 'no', 'Thu', 'All', 'par-2', 7),
(54, 'Party Platter Deluxe', 'Whether you’re hosting a casual gathering, a holiday cocktail party or a birthday celebration, we have all the snacks, sips and sweets you need to please a crowd.', '49.99', 'party-platter-deluxe', 'no', 'Sun', 'All', 'par-1', 7);
...
--
ALTER TABLE `sp19_products`
  MODIFY `prodid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
COMMIT;
